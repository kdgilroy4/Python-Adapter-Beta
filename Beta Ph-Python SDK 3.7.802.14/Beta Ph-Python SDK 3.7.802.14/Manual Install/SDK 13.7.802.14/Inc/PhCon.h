...
typedef struct tagCAMERAOPTIONS
{
    ...
    RGBQUAD OSDColor[8];    // set of colors used for the OSD painting
							// Background
							// Wtr mode
							// Trig mode
							// Cst mode
...
#define PHCONHEADERVERSION 787      // Call PhRegisterClientEx(...,PHCONHEADERVERSION) using this value
...
#define DFOURGIG 4294967296.0		//1<<32, divide TIME64.fractions to this to get seconds
...
#define gsHasV2LockAtTrigger								2002
...
#define gsEthernet10GAddress                                1093        // rw 10G IP Address
#define gsEthernet10GMask                                   1094        // rw 10G IP subnet mask
#define gsEthernet10GBroadcast                              1095        // rw 10G IP broadcast
#define gsEthernetDefaultAddress                            1096        // ro 1G default IP address (Ip address in hardware)
...
#define gsSensorModesList                                   1087        //ro   Get list of camera Sensor modes; currently used for Flex 4K GS, VEO 4K and Virgo V2640
#define gsSensorMode                                        1088        //rw   Get/Set Sensor Mode; currently used for Flex 4K GS, VEO 4K and Virgo V2640
...
#define gsUpTime                                            1120        //ro   (info.uptime) Get total power on times in hours (return -1 if not supportted)
#define gsStartUps                                          1121        //ro   (info.startups) Get number of power cycles or boot ups (return -1 if not supportted)
...
#define GV_VSHUTTER_FIRMWARE 12
...
// PhSetDllsOption(), PhSetDllsOption() selectors
#define DO_IGNORECAMERAS		1
#define DO_PERCAMERAACQPARAMS	2
#define DO_SUPPRESSOFFLINESTAMP 7
#define DO_ANGLEUNITS			9 //display range data angles in degrees, decimals (1) instead of deg, min sec (0)
...
#define SYNC_SYNCTOTRIGGER	5		// acquire frame #1 exactly 1 period after trigger
/*****************************************************************************/
...
#define CFA_BAYERFLIP		4		// rg/gb	//our basic Bayer, flipped vertical
#define CFA_BAYERFLIPV		CFA_BAYERFLIP
#define CFA_BAYERFLIPB		5		// gr/bg	//flip both V and H
#define CFA_BAYERFLIPH		6		// bg/gr	//flip horizontal
...
// Nucleus Firmware Upgrade Types

#define FW_PHFW                 1   // PH16 camera Phfw
#define FW_FIRMWARE             2
#define FW_FPGA                 3
#define FW_FLASH_FPGA           4
#define FW_MAGAZINE             5
#define FW_10G_FPGA             6
#define FW_KERNEL_FLA           7
#define FW_KERNEL_NFS           8
...
// Nucleus functions
//
EXIMPROC HRESULT PhUpgradeFirmware(UINT IpAddress, UINT CamVer, UINT Selector, PSTR fileName);
...
#define ERR_BadSensorMode               (140)
#define ERR_CameraOffline               (141)
#define ERR_InvalidFIle                 (142)

#define ERR_BatteryFailure              (175)
...
// from NI boards
#define ERR_EarlyTrigger				(-200281)	//DAQmxErrorCannotReadRelativeToRefTrigUntilDone
#define ERR_NoStrobePulses				(-200284)	//DAQmxErrorSamplesNotYetAvailable
...
typedef struct tagIMPARAMS
{
    WBGAIN WBGain[4];       // Gain adjust on R,B components, for white balance,
							// 1.0 = do nothing,
							// index 0: full image for v4,5,7...TL head for v6
...
#define GI_PACKED12L 0x400		// return the pixels as read from camera; possible packed 12 bit lin (2 pixels in 3 bytes) 
...
EXIMPROC HRESULT PhStartIttRecorder(UINT CN);
EXIMPROC HRESULT PhStopIttRecorder(UINT CN);
