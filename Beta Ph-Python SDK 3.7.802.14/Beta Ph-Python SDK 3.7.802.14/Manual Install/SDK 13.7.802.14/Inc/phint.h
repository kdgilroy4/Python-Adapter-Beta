...
typedef struct tagSETUP
{
    ...
    uint8_t AnaBoard;       // Board type 0=none, 1=dsk (DSP system kit),
							...
							//10 National Instruments X series USB
    ...
    uint32_t SensorMode;    // Camera sensor Mode used to define what mode the Sensor is in
                            // This is currently valid for the Flex4K, VEO 4K and  VIRGO V2640
                            ...
                            // 0x0000 = Standard        ACDS12b
                            // 0x0001 = NA              ACDS10b
                            // 0x0010 = Standard_Binned ACDS12bBINNED
                            // 0x0011 = NA              ACDS10bBINNED
                            // 0x0100 = NA              SE12b (single ended 12b / pixel)
                            // 0x0101 = HS              SE10b (single ended 10b / pixel)
                            // 0x0110 = NA              SE12bbinned (single ended 12b / pixel)
                            // 0x0111 = HS_Binned       SE10bbinned (single ended 10b / pixel)
...
#define BITENC      2	//encoding subfield starting with bit 2
